...
public class KnightCornerMovesTest {
    ...
    public KnightCornerMovesTest(Coordinate origin, Player player, List<Coordinate> expectedMoves) {
        this.origin = origin;
        this.player = player;
    ...
    public static Collection<Object[]> cases() {
        return Arrays.asList(new Object[][] {
                {
                        new Coordinate(1, 1), Player.WHITE,
                        List.of(new Coordinate(2, 3), new Coordinate(3, 2))
                },
                {
                        new Coordinate(8, 1), Player.WHITE,
                        List.of(new Coordinate(7, 3), new Coordinate(6, 2))
                },
                {
                        new Coordinate(1, 8), Player.BLACK,
                        List.of(new Coordinate(2, 6), new Coordinate(3, 7))
                },
                {
                        new Coordinate(8, 8), Player.BLACK,
                        List.of(new Coordinate(7, 6), new Coordinate(6, 7))
                }
        });
    }
